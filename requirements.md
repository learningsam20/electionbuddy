...
1.  **Citizen (Public User):**
    ...
    *   **Features:** Learn election phases, Voice/Text Gemini Assistant, Play AI Quizzes, View personal stats (Points, Badges, District average comparison).
    *   **Default Test User:** `citizen@democraplay.com` / `Citizen@123`
2.  **Election Officer:**
    *   **Registration:** Admin-invited only.
    *   **Features:** RAG guidelines, content moderation, rich analytics (Assembly-wise turnout/registration stats, male vs. female ratios, generation-wise metrics like GenZ vs Millennials).
    *   **Default Test User:** `officer@democraplay.com` / `Officer@123`
3.  **Political Candidate / Campaign Manager:**
    *   **Registration:** Admin-invited only.
    *   **Features:** Nomination guidelines, expenditure tracking rules, campaign media AI compliance check (upload to quarantine).
    *   **Default Test User:** `candidate@democraplay.com` / `Candidate@123`
4.  **Super Admin:**
    *   **Registration:** System generated.
    *   **Features:** Manage roles (invite Officers and Candidates), view telemetry and GCP costs.
    *   **Default Test User:** `admin@democraplay.com` / `Admin@123`
